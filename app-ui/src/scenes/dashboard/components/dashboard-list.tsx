...
const StockGrid = (props: { stocks: Stock[] }) => {
  ...
  const [columnDefs] = useState<ColDef[]>([
    { field: translate.formatMessage({ id: "stock.grid.symbol" }), headerClass: "header" },
    { field: translate.formatMessage({ id: "stock.grid.name" }), headerClass: "header" },
    { field: translate.formatMessage({ id: "stock.grid.close" }), headerClass: "header" },
    { field: translate.formatMessage({ id: "stock.grid.high" }), headerClass: "header" },
    { field: translate.formatMessage({ id: "stock.grid.low" }), headerClass: "header" },
    { field: translate.formatMessage({ id: "stock.grid.volume" }), headerClass: "header" },
    {
      field: translate.formatMessage({ id: "stock.grid.variation" }),
      headerClass: "header",
      cellRenderer: VariationCellRenderer,
    },
    {
      field: translate.formatMessage({ id: "stock.grid.action" }),
      headerClass: "header",
