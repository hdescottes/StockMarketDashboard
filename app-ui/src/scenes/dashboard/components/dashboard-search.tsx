    ...
    <div>
      <Section>
        <Box display="flex" justifyContent="flex" height="30px">
          ...
          <ButtonCustom title={translate.formatMessage({ id: "button.fetch" })} onClick={fetch} />
          <ButtonCustom title={translate.formatMessage({ id: "button.search.all" })} onClick={search} />
        </Box>
      </Section>
    </div>
  );
