        ...
        <Grid sx={{ flexGrow: 3 }}>
          <Box display="flex" className="ps-5 pb-3">
            <Box data-testid="open" className="pe-3">
              ...
              >
                {translate.formatMessage({ id: "stock.info.open" })}
              </Typography>
            ...
            <Box data-testid="prevClose">
              <Typography
                ...
                color={colors.grey[600]}
              >
                {translate.formatMessage({ id: "stock.info.previous.close" })}
              </Typography>
              <Typography variant="h5" fontWeight="600">
                <SkeletonCustom
          ...
          <Box display="flex" className="ps-5">
            <Box data-testid="high" className="pe-3">
              <Typography
                ...
                color={colors.grey[600]}
              >
                {translate.formatMessage({ id: "stock.info.high" })}
              </Typography>
              <Typography variant="h5" fontWeight="600">
                <SkeletonCustom
                  data={props.stock}
            ...
            <Box data-testid="low">
              <Typography
                ...
                color={colors.grey[600]}
              >
                {translate.formatMessage({ id: "stock.info.low" })}
              </Typography>
              <Typography variant="h5" fontWeight="600">
                <SkeletonCustom
                  data={props.stock}
        ...
        <Grid sx={{ flexGrow: 3 }}>
          <Box data-testid="volume" className="ps-5">
            <Typography
              ...
              color={colors.grey[600]}
            >
              {translate.formatMessage({ id: "stock.info.volume" })}
            </Typography>
            <Typography variant="h5" fontWeight="600">
              <SkeletonCustom
                data={props.stock}
        ...
        <Grid sx={{ flexGrow: 3 }}>
          <Box data-testid="date" className="ps-5">
            <Typography
              ...
              color={colors.grey[600]}
            >
              {translate.formatMessage({ id: "stock.info.date" })}
            </Typography>
            <Typography variant="h5" fontWeight="600">
              <SkeletonCustom
                data={props.stock}
